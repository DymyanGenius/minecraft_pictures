scoreboard players set @s bv_stage 8
...
tellraw @s {"text":"Остров висит в пустоте, как точка в конце старой сказки. Победи дракона — после этого тебе придется выбрать, каким станет мир.","color":"gray"}
