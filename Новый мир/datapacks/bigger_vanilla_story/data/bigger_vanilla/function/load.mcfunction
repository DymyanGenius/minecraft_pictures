...
tellraw @a [{"text":"[Bigger Vanilla] ","color":"gold","bold":true},{"text":"полная версия загружена: стандартные крафты заблокированы, рецепты продаются торговцами случайно. Используй ","color":"gray"},{"text":"/function bigger_vanilla:menu/open","color":"yellow"},{"text":" или ","color":"gray"},{"text":"/function bigger_vanilla:guide","color":"yellow"},{"text":".","color":"gray"}]
